...
import com.balex.weatherapp.domain.usecase.SearchCityUseCase
import com.balex.weatherapp.presentation.search.SearchStore.Intent
import com.balex.weatherapp.presentation.search.SearchStore.Label
import com.balex.weatherapp.presentation.search.SearchStore.State
...
//    }
    ...
    private inner class ExecutorImpl(private val openReason: OpenReason) : CoroutineExecutor<Intent, Nothing, State, Msg, Label>() {
